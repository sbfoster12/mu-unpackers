...
BUILD_NALU=OFF
echo "[build.sh] Running cmake with -DCMAKE_INSTALL_PREFIX=$INSTALL_PREFIX -DBUILD_NALU=${BUILD_NALU}"
cmake -DCMAKE_INSTALL_PREFIX="$INSTALL_PREFIX" -DBUILD_NALU=${BUILD_NALU} "$BASE_DIR"
