...
echo "[build.sh] Running cmake with -DCMAKE_INSTALL_PREFIX=$INSTALL_PREFIX -DBUILD_NALU=${BUILD_NALU} -DBUILD_EXECUTABLE=${BUILD_EXECUTABLE}"
cmake -DCMAKE_INSTALL_PREFIX="$INSTALL_PREFIX" -DBUILD_NALU=${BUILD_NALU} -DBUILD_EXECUTABLE=${BUILD_EXECUTABLE} "$BASE_DIR"
