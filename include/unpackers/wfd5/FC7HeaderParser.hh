...
namespace unpackers::wfd5 {
    ...
    class FC7HeaderParser : public unpackers::common::Parser {
    ...
    public:
        ...
        std::unique_ptr<data_products::wfd5::FC7Header> NewDataProduct(unsigned int crateNum);
        ...
        ClassDefOverride(FC7HeaderParser,1)
