...
namespace unpackers::wfd5 {
    ...
    class ChannelHeaderAsyncParser : public unpackers::common::Parser {
    ...
    public:
        ...
        std::unique_ptr<data_products::wfd5::ChannelHeader>
        ...
        ClassDefOverride(ChannelHeaderAsyncParser,1)
