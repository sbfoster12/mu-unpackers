...
namespace unpackers {
    ...
    public:
        ...
        virtual unpackingStatus UnpackEvent(TMEvent* event) = 0;

        virtual unpackingStatus UnpackBank(uint64_t* bank_data, unsigned int total_words, int serial_number, std::string bank_name) = 0;
