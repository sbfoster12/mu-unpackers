...
NaluTimeParser::NaluTimeParser() : unpackers::Parser() {

    //Set each data location to its default values
    collection_cycle_index_data_location_ =             unpackers::DataLocation(0,0,8);
    collection_cycle_time_stamp_ns_data_location_ =     unpackers::DataLocation(1,0,8);
    udp_time_data_location_ =                           unpackers::DataLocation(2,0,8);
    parse_time_data_location_ =                         unpackers::DataLocation(3,0,8);
    event_time_data_location_ =                         unpackers::DataLocation(4,0,8);
    total_time_data_location_ =                         unpackers::DataLocation(5,0,8);
    data_processed_data_location_ =                     unpackers::DataLocation(6,0,8);
    data_rate_data_location_ =                          unpackers::DataLocation(7,0,8);
