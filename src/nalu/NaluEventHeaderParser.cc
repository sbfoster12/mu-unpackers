...
NaluEventHeaderParser::NaluEventHeaderParser() : unpackers::Parser() {

    event_header_data_location_ =                         unpackers::DataLocation(0,0,2);
    event_info_data_location_ =                           unpackers::DataLocation(0,16,1);
    event_index_data_location_ =                          unpackers::DataLocation(0,24,4);
    event_reference_time_data_location_ =                 unpackers::DataLocation(0,56,1,1,0,3);
    packet_size_data_location_ =                          unpackers::DataLocation(1,24,2);
    channel_mask_data_location_ =                         unpackers::DataLocation(1,40,3,2,0,5);
    num_windows_data_location_ =                          unpackers::DataLocation(2,40,1);
    num_packets_data_location_ =                          unpackers::DataLocation(2,48,2);
