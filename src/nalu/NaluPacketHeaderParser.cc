...
NaluPacketHeaderParser::NaluPacketHeaderParser() : unpackers::Parser() {

     //Set each data location to its default values
    packet_header_data_location_ =              unpackers::DataLocation(0,0,2);
    packet_info_data_location_ =                unpackers::DataLocation(0,16,1);
    channel_data_location_ =                    unpackers::DataLocation(0,24,1);
    trigger_time_data_location_ =               unpackers::DataLocation(0,32,4);
    logical_position_data_location_ =           unpackers::DataLocation(1,0,2);
    window_position_data_location_ =            unpackers::DataLocation(1,16,2);
