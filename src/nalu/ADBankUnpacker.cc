...
int ADBankUnpacker::UnpackBank(uint64_t* bankData, unsigned int totalWords, int serialNumber, int crateNum) {
...
int ADBankUnpacker::UnpackBank(TMEvent* event, const std::string& bankName) {
