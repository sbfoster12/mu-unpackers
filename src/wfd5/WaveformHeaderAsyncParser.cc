...
WaveformHeaderAsyncParser::WaveformHeaderAsyncParser() : unpackers::common::Parser() {};

WaveformHeaderAsyncParser::~WaveformHeaderAsyncParser() {};

std::unique_ptr<data_products::wfd5::WaveformHeader>
WaveformHeaderAsyncParser::NewDataProduct(unsigned int crateNum
                                    ,unsigned int amcNum) {
    return std::make_unique<data_products::wfd5::WaveformHeader>(
                crateNum
                ,amcNum
                ,0
                ,0
