...
FC7HeaderParser::FC7HeaderParser() : unpackers::common::Parser() {};

FC7HeaderParser::~FC7HeaderParser() {};

std::unique_ptr<data_products::wfd5::FC7Header> FC7HeaderParser::NewDataProduct(unsigned int crateNum) {
    return std::make_unique<data_products::wfd5::FC7Header>(crateNum
                ,AMCNo()
                ,TrigNum()
                ,TimeStamp()
                ,TriggerType()
